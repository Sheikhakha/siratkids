...
7. Entry points: lesson-aside practice card + remove lesson-wise pill + keep hub CTAs + ✓ badge
   (`js/main.js` CTA IIFE line 1745+ + `css/style.css`).
8. Save-on-Practiced-✓ verified + saved confirmation (`js/worksheet.js`, skStore).
9. Stage-0 static printable activity pages (3 recommended: الله الخالق coloring, أسمّي النعم, لماذا خلقنا الله Q&A).
